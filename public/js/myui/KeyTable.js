...
KeyTable.prototype = {
    initialize: function (targetTable, options) {
        ...
        if (this._tableGrid)
            this.idPrefix = 'mtgC' + this._tableGrid._mtgId + '_';
    ...
    onKeyPress: function (event) {
        if (this.blockFlg || !this.blockKeyCaptureFlg)
            return true;
    ...
    setFocus: function (nTarget, bAutoScroll) {
        ...
        if (this._nCurrentFocus != null)
            this.removeFocus(this._nCurrentFocus);
    ...
    stop: function () {
        ...
        if (this._onClickHandler)
            Event.stopObserving($(document), 'click', this._onClickHandler);
    }
};