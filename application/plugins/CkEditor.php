...
/**
 * Default_Plugin_CkEditor
 *
 * Класс создания визуального редактора CkEditor
 *
 * Sample usage:
 * @code
...
class Default_Plugin_CkEditor
{
	 ...
	 */
	//public $textareaAttributes = array( "rows" => 8, "cols" => 60, "style" => "visibility: hidden; display: none;" );
